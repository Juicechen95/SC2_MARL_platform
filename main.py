...
from agt1.Config import Config as Config1
from agt2.Agent import Agent as Agt2
from agt2.Config import Config as Config2
import sys
...
def parse_arg():
    ...
    parser.add_argument('-max_iter_num', type=int, default=int(1e3))
...
if __name__ == '__main__':
    ...
    model = Model(Agt1, Config1, Agt2, Config2, args)
